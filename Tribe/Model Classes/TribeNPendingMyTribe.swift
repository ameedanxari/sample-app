//
//	TribeNPendingMyTribe.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TribeNPendingMyTribe : NSObject, NSCoding{

	var v : Int!
	var id : String!
	var active : Bool!
	var added : TribeNAdded!
	var addedBy : TribeNAdded!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let addedByData = dictionary["added_by"] as? [String:Any]{
			addedBy = TribeNAdded(fromDictionary: addedByData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         addedBy = aDecoder.decodeObject(forKey: "added_by") as? TribeNAdded
